...
%description -l pl
wxScintilla jest implementacj± kontrolki edycyjnej Scintilla wykorzystuj±c±
API wxWidgets. Jest rozwiniêciem wxStyledTextCtrl (napisanej przez Robina Dunna)
i posiada tak± sam± funkcjonalno¶æ oraz zbli¿one API. Niemal¿e jedyn± ró¿nic±
(poza nazw±) jest znacznie szybszy cykl wydawania nowych wersji.
